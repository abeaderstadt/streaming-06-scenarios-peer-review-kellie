...
transactions as low, medium, or high based on the final transaction total.
...
These categories help identify spending patterns and summarize customer purchase
behavior across the stream.
...
You should also see sales records stored in DuckDB, a generated sales chart, and
analytics summarizing the number of low, medium, and high value transactions.
